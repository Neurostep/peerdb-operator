...
var _ = Describe("PeerDBSnapshotPool Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind PeerDBSnapshotPool")
			err := k8sClient.Get(ctx, typeNamespacedName, peerdbsnapshotpool)
